...
function AccountOperations() {
  ...
  const account = useSelector((store) => store.account); console.log(account);
  // const {balance, loan, loanPurpose : purpose, isLoading} = useSelector((store)=>store.account);  // ! We can DESTRUCT and make some name property changing
  ...
  return (
    <div>
      ...
      <div className="inputs">
        ...
        {account.loan > 0 && <div>
          <span>Pay back <strong>${account.loan}</strong> for "{account.loanPurpose}"</span>
